...
public class OpenApiConfig {
    ...
    OpenAPI myOpenAPI() {
        ...
        Info info = new Info().title("API Residência Projeto Final")
                .version("1.0")
                .contact(contact)
                .description("API desenvolvida para o projeto final da residência 2025-01, desenvolvida por: Elton Giglio Kasesky, Marcelo Lopes Vidal e José Augusto dos Santos Junior")
